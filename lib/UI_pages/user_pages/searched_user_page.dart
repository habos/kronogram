...
class SearchedUserPage extends StatefulWidget{
  SearchedUserPage({Key key, this.userId)
      :super(key:key);
  ...
  State<StatefulWidget> createState(){
    return _SearchedUserPageState();
  }

}

class _SearchedUserPageState extends State<SearchedUserPage>{
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: PreferredSize(
        ...
        child: searchedUserAppBar(userId: widget.userId, username: widget.username,
          //height: 100,
        ),
      ),
